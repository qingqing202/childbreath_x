...
import childbreath.service.MyX509TrustManager;
...
public class WeixinUtil {
	...
	public static JSONObject UploadFile( String type, File file ){
		JSONObject jsonObject = null;
		String url = uploadUrl.replace("ACCESS_TOKEN", AccessTokenMgr.getInstance().getAccessToken()).replace("TYPE", type);
		//定义数据分隔符
